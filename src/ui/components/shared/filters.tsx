...
// Inventory Filters
export const INVENTORY_FILTERS = ['ALL', 'EQUIPMENT', 'ALMS BOX', 'BACKPACK', 'POUCH', 'ATTUNEMENT', 'OTHER POSSESSIONS'];

// Feature Filters
export const FEATURE_FILTERS = ['ALL', 'CLASS_FEATURES', 'SPECIES_TRAITS', 'FEATS'];
